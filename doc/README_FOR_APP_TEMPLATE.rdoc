...
* chmod +x $rvm_path/hooks/after_cd_bundler - with rvm integration enabled, the “bin” directory is added to your path each time you cd into a project directory with binstubs.
