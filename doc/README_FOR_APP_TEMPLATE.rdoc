...
* DRY controllers: Decent exposure, https://github.com/voxdolo/decent_exposure
...
* Exceptions handling: airbrake.io
...
We use Devise for login based auth b/c is modular and have a good community support.
Take a look at config/initializers/devise.rb if you want customize it.
