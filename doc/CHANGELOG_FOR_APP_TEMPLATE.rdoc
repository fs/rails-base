...
* We use slim for all views for now
* New nice styling 
* flutie gem replaced with styleguides gem (onlu /styleguides support)
* Removed omniauth from the template b/c we should have very simple app
* Cleaned up cucumber steps
...
* Added mail_safe gem - app won’t send emails to external email addresses in the development and test envs
