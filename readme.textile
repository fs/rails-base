h1. Skeleton for new Rails 3 based application
...
(Over)use describe and context
  ...
  describe User do
    ...
    context "when name empty" do
      ...
      specify { @user.save.should h2. false }
    end
    ...
    context "when name not empty" do
      ...
      it { should be_valid }
      specify { @user.save.should h2. true }
    end
...
h2.  How to update existing project with new changes from rails3-base repo
